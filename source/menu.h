...
enum CURRENT_MENU { MAIN_MENU, CONTROLLER_TEST, WAVEFORM,
		PLOT_2D, IMAGE_TEST, FILE_EXPORT,
		WAITING_MEASURE, COORD_MAP, CONTINUOUS_WAVEFORM,
		TRIGGER_WAVEFORM, GATE_MEASURE, ERR };
