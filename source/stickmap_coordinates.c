			...
			if (coords.isAYNegative) {
				...
				for (int i = 0; i < STICKMAP_SHIELDDROP_COORD_VANILLA_LEN; i++) {
					if ((coords.ax == STICKMAP_SHIELDDROP_COORD_VANILLA[i][0] &&
					    ...
					    (coords.ay == STICKMAP_SHIELDDROP_COORD_VANILLA[i][0] &&
					     coords.ax == STICKMAP_SHIELDDROP_COORD_VANILLA[i][1])) {
						ret = 1;
						break;
					}
				}
				...
				for (int i = 0; i < STICKMAP_SHIELDDROP_COORD_UCF_LOWER_LEN; i++) {
					if ((coords.ax == STICKMAP_SHIELDDROP_COORD_UCF_LOWER[i][0] &&
					    ...
					    (coords.ay == STICKMAP_SHIELDDROP_COORD_UCF_LOWER[i][0] &&
					     coords.ax == STICKMAP_SHIELDDROP_COORD_UCF_LOWER[i][1])) {
						ret = 2;
						break;
					}
				}
				...
				for (int i = 0; i < STICKMAP_SHIELDDROP_COORD_UCF_UPPER_LEN; i++) {
					if ((coords.ax == STICKMAP_SHIELDDROP_COORD_UCF_UPPER[i][0] &&
					    ...
					    (coords.ay == STICKMAP_SHIELDDROP_COORD_UCF_UPPER[i][0] &&
					     coords.ax == STICKMAP_SHIELDDROP_COORD_UCF_UPPER[i][1])) {
						ret = 3;
						break;
					}
				}
